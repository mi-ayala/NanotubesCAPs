...
### A proof of the (5,5)-nanotube with pentagonal caps and N = 670 atoms using the harmonic potential. We minimize the energy and validate the simulation. All the other examples follow the same implementation structure.
...
# ### Save the data 
# save("data/5-5_PentCaps_N670_Harmonic.jld2", "x_newton", x_newton, "r", r)

### The data is saved to be loaded and analyzed in the file `plots_5-5_PentCaps_N670_Harmonic.jl`, where we generate plots and examine the results.